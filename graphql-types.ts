...
export type IndexQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt' | 'id'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'path'>> }
      ) }> } };
...
export type PagesForBuildQueryVariables = {};


export type PagesForBuildQuery = { allMarkdownRemark: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path'>> } }> } };
